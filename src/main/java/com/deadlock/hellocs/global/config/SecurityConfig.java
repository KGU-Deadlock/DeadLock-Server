...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:5173", "https://localhost:5173", "https://hellocs.site", "https://api.hellocs.site"));
    ...
    Customizer<HttpSecurity> authorizeCustomizer() {
        return http -> http
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/v1/interview/**").authenticated()
