package com.deadlock.hellocs.grading.adapter.in.web.docs;
...
public interface QuizGradingControllerDocs {
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "요청 본문 검증 실패", content = @Content),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "인증 실패", content = @Content),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "채점 대상 퀴즈를 찾을 수 없음", content = @Content),
    ...
    ApiResponse<SubmitAnswerResponse> submitAnswers(
            ...
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "사용자 답안 목록", required = true)
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "인증 실패", content = @Content),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "해당 채점 기록에 대한 접근 권한 없음", content = @Content),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "채점 로그를 찾을 수 없음", content = @Content),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "서버 내부 오류", content = @Content)
    })
    ApiResponse<GradingLogResult> getGradingLog(
            @Parameter(hidden = true) @CurrentUser Long requesterId,
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "인증 실패", content = @Content),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "해당 채점 기록에 대한 접근 권한 없음", content = @Content),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "채점 상세를 찾을 수 없음", content = @Content),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "서버 내부 오류", content = @Content)
    })
